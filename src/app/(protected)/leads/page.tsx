...
import { openModal } from "@/components/common/modalSlice";
                        ...
                        <tbody>
                            {leads.map((l: Lead, k: number) => (
                                <tr key={k}>
                                    ...
                                    <td>{l.last_name}</td>
                                    <td><button className="btn btn-square btn-ghost" onClick={() => deleteCurrentLead(k)}><HiTrash className="w-5" /></button></td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
